...
import 'package:shop_app/feature/home/presentation/view/screen/details_view.dart';
import 'package:shop_app/feature/home/presentation/view/widget/custom_appbar.dart';
import 'package:shop_app/feature/home/presentation/view/widget/custom_card.dart';
          ...
          return Scaffold(
            ...
            body: ListView.builder(
              ...
              itemBuilder: (context, index) {
                return CustomCard(
                  productModel: state.prducts[index],
                  ontap: () {
                    Navigator.push(context,
                        MaterialPageRoute(builder: (context) {
                      return  DetailsView(productModel: state.prducts[index],);
                    }));
                  },
                );
              },
